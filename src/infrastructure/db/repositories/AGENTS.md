...
| `cached-authorization.repo.ts`       | Cached permission resolution (wraps authorization) |
| `content.repo.ts`                    | Content entity CRUD                                |
| `content-job.repo.ts`                | Content ingestion job tracking                     |
| `content-playlist-reporting.repo.ts` | Content-playlist relationship queries              |
...
| Directory | Purpose                                   |
| --------- | ----------------------------------------- |
| `utils/`  | Database utilities (`date.ts` formatting) |
